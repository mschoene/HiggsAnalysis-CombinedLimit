...
command=`cp /work/mschoene/CMSSW_7_4_7_gg/src/HiggsAnalysis/CombinedLimit/CMS-HGG_13TeV_sigfit_2019mar30_${MODEL}*.root ${JOBDIR}/`
echo ${command}
...
command=`combine -M Asymptotic  -m 125 $MYCARD  >& ${MYCARD}.logging`
echo $command

command=`cp  ${MYCARD}.logging ${MYPATH}/limits/`
echo $command
